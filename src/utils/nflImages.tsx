...
export const NFL_IMAGES = {
  ...
  merchandise: {
    ...
    apparelFlatlay: "https://images.unsplash.com/photo-1556906781-9a412961c28c?auto=format&fit=crop&q=80&w=800", // Training gear, sneakers, and sports wear
    ...
    helmet: "https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&q=80&w=800", // Authentic helmets and equipment
    football: "https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&q=80&w=800", // Real leather game ball "The Duke"
...
export function getNFLImage(item: {
  ...
  if (!baseSrc) {
    ...
    if (isJersey) {
      if (teamId === "DAL") baseSrc = "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&q=80&w=800";
      else if (teamId === "MIN") baseSrc = "https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?auto=format&fit=crop&q=80&w=800";
      else if (teamId === "KC" || teamId === "SF") baseSrc = "https://images.unsplash.com/photo-1544698310-74ea9d1c8258?auto=format&fit=crop&q=80&w=800";
      else baseSrc = "https://images.unsplash.com/photo-1594470117722-de4b9a02ebed?auto=format&fit=crop&q=80&w=800";
    } else if (isHoodieOrJacket) {
      if (teamId === "DAL" || teamId === "MIN") baseSrc = "https://images.unsplash.com/photo-1628155930542-3c7a64e2c833?auto=format&fit=crop&q=80&w=800";
      else if (teamId === "KC" || teamId === "SF") baseSrc = "https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&q=80&w=800";
      else baseSrc = "https://images.unsplash.com/photo-1556906781-9a412961c28c?auto=format&fit=crop&q=80&w=800";
    } else if (isHelmet) {
      baseSrc = "https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&q=80&w=800";
    } else if (isCap) {
